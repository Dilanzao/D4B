...
const v310Translations = {
  'pt-BR': { v310: {
    account: {
      loginTitle:'Entrar', loginDescription:'Acesse sua conta para usar servidores e preços da comunidade.', email:'E-mail', password:'Senha', keepConnected:'Manter conectado', enter:'Entrar', forgotPassword:'Esqueci minha senha', createAccount:'Criar conta', registerTitle:'Criar conta', registerDescription:'Crie uma conta simples para colaborar com os preços do seu servidor.', displayName:'Nome de exibição', server:'Servidor', selectServer:'Selecione um servidor', confirmPassword:'Confirmar senha', alreadyHaveAccount:'Já tenho uma conta', forgotTitle:'Recuperar senha', forgotDescription:'Enviaremos um link de uso único para o e-mail cadastrado.', sendRecovery:'Enviar instruções', backToLogin:'Voltar para entrar', verifyTitle:'Confirmar e-mail', verifyDescription:'Estamos validando o link da sua conta.', verifying:'Confirmando seu e-mail…', verified:'E-mail confirmado. Sua conta está pronta para acesso.', verificationFailed:'Não foi possível confirmar este e-mail.', verificationWaiting:'Aguardando o token de confirmação.', resetTitle:'Definir nova senha', resetDescription:'Crie uma nova senha exclusiva para o Dofus4Business.', newPassword:'Nova senha', saveNewPassword:'Salvar nova senha', settingsTitle:'Configurações de conta', settingsDescription:'Altere o servidor ativo, a origem padrão dos preços e a segurança da conta.', loginRequired:'Entre para acessar as configurações da conta.', preferences:'Preferências da conta', currentServer:'Servidor em uso', pricePreference:'Origem padrão dos preços', communityPrices:'Usar preços mais recentes da comunidade', communityPricesHelp:'Carrega o último preço informado para o servidor selecionado.', ownPrices:'Usar somente preços informados por mim', ownPricesHelp:'Ignora registros enviados por outros jogadores.', changePassword:'Trocar senha', currentPassword:'Senha atual', logout:'Sair', logoutAll:'Encerrar todas as sessões', notConnected:'Não conectado', passwordWarning:'Não utilize a mesma senha da sua conta Ankama ou DOFUS.', communityTitle:'Preços por servidor', communityText:'Jogadores conectados ajudam a manter os ingredientes atualizados sem substituir os preços salvos dentro de projetos antigos.', apiNotConfiguredTitle:'API de contas ainda não configurada'
    },
    prices: {
      referencePrice:'Preço de referência', communitySource:'Comunidade', ownSource:'Informado por você', noPrice:'Sem preço para este servidor', updatedToday:'Atualizado hoje', updatedOneDay:'Atualizado há 1 dia', updatedDays:'Atualizado há {count} dias', usePrice:'Usar este preço', pendingSend:'Alteração pendente', saving:'Enviando…', saved:'Preço enviado', saveError:'Falha ao enviar', loginToUse:'Entre para carregar e compartilhar preços.', loginProjectInfo:'Entre para vincular o projeto a um servidor e usar preços da comunidade.', projectServer:'Servidor do projeto', refresh:'Atualizar preços', observedPrice:'Preço observado no mercado', observedPriceHelp:'Ao alterar e confirmar este campo, uma nova referência será enviada à comunidade.', staleWarning:'Preço possivelmente desatualizado', projectWithoutServer:'Selecione um servidor nas configurações da conta.'
    }
  } },
  'fr-FR': { v310: {
    account: {
      loginTitle:'Connexion', loginDescription:'Connectez-vous pour utiliser les serveurs et les prix de la communauté.', email:'E-mail', password:'Mot de passe', keepConnected:'Rester connecté', enter:'Se connecter', forgotPassword:'Mot de passe oublié', createAccount:'Créer un compte', registerTitle:'Créer un compte', registerDescription:'Créez un compte simple pour contribuer aux prix de votre serveur.', displayName:'Nom affiché', server:'Serveur', selectServer:'Sélectionnez un serveur', confirmPassword:'Confirmer le mot de passe', alreadyHaveAccount:'J’ai déjà un compte', forgotTitle:'Récupérer le mot de passe', forgotDescription:'Un lien à usage unique sera envoyé à l’adresse enregistrée.', sendRecovery:'Envoyer les instructions', backToLogin:'Retour à la connexion', verifyTitle:'Confirmer l’e-mail', verifyDescription:'Validation du lien de votre compte.', verifying:'Confirmation de votre e-mail…', verified:'E-mail confirmé. Votre compte est prêt.', verificationFailed:'Impossible de confirmer cet e-mail.', verificationWaiting:'En attente du jeton de confirmation.', resetTitle:'Définir un nouveau mot de passe', resetDescription:'Créez un mot de passe réservé à Dofus4Business.', newPassword:'Nouveau mot de passe', saveNewPassword:'Enregistrer le mot de passe', settingsTitle:'Paramètres du compte', settingsDescription:'Modifiez le serveur actif, la source des prix et la sécurité du compte.', loginRequired:'Connectez-vous pour accéder aux paramètres.', preferences:'Préférences du compte', currentServer:'Serveur utilisé', pricePreference:'Source de prix par défaut', communityPrices:'Utiliser les prix récents de la communauté', communityPricesHelp:'Charge le dernier prix du serveur sélectionné.', ownPrices:'Utiliser uniquement mes prix', ownPricesHelp:'Ignore les prix envoyés par les autres joueurs.', changePassword:'Changer le mot de passe', currentPassword:'Mot de passe actuel', logout:'Déconnexion', logoutAll:'Fermer toutes les sessions', notConnected:'Non connecté', passwordWarning:'N’utilisez pas le même mot de passe que votre compte Ankama ou DOFUS.', communityTitle:'Prix par serveur', communityText:'Les joueurs connectés maintiennent les ingrédients à jour sans modifier les projets historiques.', apiNotConfiguredTitle:'API de comptes non configurée'
    },
    prices: {
      referencePrice:'Prix de référence', communitySource:'Communauté', ownSource:'Indiqué par vous', noPrice:'Aucun prix pour ce serveur', updatedToday:'Mis à jour aujourd’hui', updatedOneDay:'Mis à jour il y a 1 jour', updatedDays:'Mis à jour il y a {count} jours', usePrice:'Utiliser ce prix', pendingSend:'En attente', saving:'Envoi…', saved:'Prix envoyé', saveError:'Échec de l’envoi', loginToUse:'Connectez-vous pour charger et partager les prix.', loginProjectInfo:'Connectez-vous pour associer le projet à un serveur.', projectServer:'Serveur du projet', refresh:'Actualiser', observedPrice:'Prix observé au marché', observedPriceHelp:'Après confirmation, une nouvelle référence sera partagée.', staleWarning:'Prix potentiellement obsolète', projectWithoutServer:'Sélectionnez un serveur dans les paramètres du compte.'
    }
  } },
  'en-US': { v310: {
    account: {
      loginTitle:'Sign in', loginDescription:'Access your account to use server-specific community prices.', email:'Email', password:'Password', keepConnected:'Keep me signed in', enter:'Sign in', forgotPassword:'Forgot my password', createAccount:'Create account', registerTitle:'Create account', registerDescription:'Create a simple account to contribute prices for your server.', displayName:'Display name', server:'Server', selectServer:'Select a server', confirmPassword:'Confirm password', alreadyHaveAccount:'I already have an account', forgotTitle:'Recover password', forgotDescription:'A one-time link will be sent to your registered email.', sendRecovery:'Send instructions', backToLogin:'Back to sign in', verifyTitle:'Confirm email', verifyDescription:'Validating your account link.', verifying:'Confirming your email…', verified:'Email confirmed. Your account is ready.', verificationFailed:'This email could not be confirmed.', verificationWaiting:'Waiting for a confirmation token.', resetTitle:'Set a new password', resetDescription:'Create a password used only for Dofus4Business.', newPassword:'New password', saveNewPassword:'Save new password', settingsTitle:'Account settings', settingsDescription:'Change the active server, default price source and account security.', loginRequired:'Sign in to access account settings.', preferences:'Account preferences', currentServer:'Current server', pricePreference:'Default price source', communityPrices:'Use latest community prices', communityPricesHelp:'Loads the latest submitted price for the selected server.', ownPrices:'Use only prices submitted by me', ownPricesHelp:'Ignores prices submitted by other players.', changePassword:'Change password', currentPassword:'Current password', logout:'Sign out', logoutAll:'Sign out all sessions', notConnected:'Not signed in', passwordWarning:'Do not use the same password as your Ankama or DOFUS account.', communityTitle:'Server-based prices', communityText:'Signed-in players keep ingredient prices current without changing historical project snapshots.', apiNotConfiguredTitle:'Account API is not configured'
    },
    prices: {
      referencePrice:'Reference price', communitySource:'Community', ownSource:'Submitted by you', noPrice:'No price for this server', updatedToday:'Updated today', updatedOneDay:'Updated 1 day ago', updatedDays:'Updated {count} days ago', usePrice:'Use this price', pendingSend:'Pending submission', saving:'Sending…', saved:'Price submitted', saveError:'Submission failed', loginToUse:'Sign in to load and share prices.', loginProjectInfo:'Sign in to link the project to a server and use community prices.', projectServer:'Project server', refresh:'Refresh prices', observedPrice:'Observed market price', observedPriceHelp:'After confirmation, a new community reference will be submitted.', staleWarning:'Price may be outdated', projectWithoutServer:'Select a server in account settings.'
    }
  } },
  'es-ES': { v310: {
    account: {
      loginTitle:'Entrar', loginDescription:'Accede a tu cuenta para usar servidores y precios de la comunidad.', email:'Correo electrónico', password:'Contraseña', keepConnected:'Mantener la sesión', enter:'Entrar', forgotPassword:'Olvidé mi contraseña', createAccount:'Crear cuenta', registerTitle:'Crear cuenta', registerDescription:'Crea una cuenta sencilla para aportar precios de tu servidor.', displayName:'Nombre visible', server:'Servidor', selectServer:'Selecciona un servidor', confirmPassword:'Confirmar contraseña', alreadyHaveAccount:'Ya tengo una cuenta', forgotTitle:'Recuperar contraseña', forgotDescription:'Enviaremos un enlace de un solo uso al correo registrado.', sendRecovery:'Enviar instrucciones', backToLogin:'Volver a entrar', verifyTitle:'Confirmar correo', verifyDescription:'Estamos validando el enlace de tu cuenta.', verifying:'Confirmando tu correo…', verified:'Correo confirmado. Tu cuenta está lista.', verificationFailed:'No se pudo confirmar este correo.', verificationWaiting:'Esperando el token de confirmación.', resetTitle:'Definir nueva contraseña', resetDescription:'Crea una contraseña exclusiva para Dofus4Business.', newPassword:'Nueva contraseña', saveNewPassword:'Guardar nueva contraseña', settingsTitle:'Configuración de cuenta', settingsDescription:'Cambia el servidor activo, el origen de precios y la seguridad.', loginRequired:'Entra para acceder a la configuración.', preferences:'Preferencias de cuenta', currentServer:'Servidor en uso', pricePreference:'Origen de precios predeterminado', communityPrices:'Usar precios recientes de la comunidad', communityPricesHelp:'Carga el último precio del servidor seleccionado.', ownPrices:'Usar solo los precios que informé', ownPricesHelp:'Ignora los precios enviados por otros jugadores.', changePassword:'Cambiar contraseña', currentPassword:'Contraseña actual', logout:'Salir', logoutAll:'Cerrar todas las sesiones', notConnected:'No conectado', passwordWarning:'No uses la misma contraseña de tu cuenta Ankama o DOFUS.', communityTitle:'Precios por servidor', communityText:'Los jugadores conectados mantienen actualizados los ingredientes sin alterar proyectos históricos.', apiNotConfiguredTitle:'La API de cuentas no está configurada'
    },
    prices: {
      referencePrice:'Precio de referencia', communitySource:'Comunidad', ownSource:'Informado por ti', noPrice:'Sin precio para este servidor', updatedToday:'Actualizado hoy', updatedOneDay:'Actualizado hace 1 día', updatedDays:'Actualizado hace {count} días', usePrice:'Usar este precio', pendingSend:'Envío pendiente', saving:'Enviando…', saved:'Precio enviado', saveError:'Error al enviar', loginToUse:'Entra para cargar y compartir precios.', loginProjectInfo:'Entra para vincular el proyecto a un servidor.', projectServer:'Servidor del proyecto', refresh:'Actualizar precios', observedPrice:'Precio visto en el mercado', observedPriceHelp:'Al confirmar, se enviará una nueva referencia.', staleWarning:'Precio posiblemente desactualizado', projectWithoutServer:'Selecciona un servidor en la configuración de cuenta.'
    }
  } }
};
for (const [language, additions] of Object.entries(v310Translations)) deepMerge(translations[language], additions);
